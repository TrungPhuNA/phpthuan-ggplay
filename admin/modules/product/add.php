<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") 
    {
        ...
        {
            $error['user_id'] = "Bạn chưa nhập nhà phát triển";
        }
        ...
        <div class="col-md-12">
            <form class="form-horizontal" action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <select class="form-control col-md-8" name="user_id" required>
                            <option value="">- Chọn nhà phát triển -</option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="inputmd3" placeholder="Mô tả" name="descs">
