<?php 
    class Database
    {
        ...
        {
            $this->link = mysqli_connect("127.0.0.1","root","root","doantotnghiep_phpthuan_appstore","8889") or die ();
        ...
        public function update($table, array $data, array $conditions)
        {
            ...
            mysqli_query($this->link, $sql) or die( "Lỗi truy vấn Update -- ".$sql . " ==  " .mysqli_error());
        ...
        {
            $result = mysqli_query($this->link,$sql) or die("Lỗi  truy vấn sql .". $sql ." ==  " .mysqli_error($this->link));
            $data = [];
            if($result)
            {
        ...
        public function fetchOne($table , $query)
        {
            ...
            $sql .= $query;
            $sql .= "LIMIT 1";
            $result = mysqli_query($this->link,$sql) or die("Lỗi  truy vấn fetchOne ".$sql. " == ". mysqli_error($this->link));
            return mysqli_fetch_assoc($result);
        }
